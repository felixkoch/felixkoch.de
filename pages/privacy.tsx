    ...
    <Container maxW={1280} pb={10}>
      ...
      <Box className="content" fontSize={["lg", "lg", "xl"]} maxWidth="4xl">
        <p>
          ...
          Geschäftsleitung der tagungshotels.info UG (haftungsbeschränkt).
          Eine Nutzung der Internetseiten der tagungshotels.info UG
          (haftungsbeschränkt) ist grundsätzlich ohne jede Angabe
        ...
        <p>
          ...
          tagungshotels.info UG (haftungsbeschränkt) geltenden
        ...
        <p>
          Die tagungshotels.info UG (haftungsbeschränkt) hat als für die
        ...
        <p>
          Die Datenschutzerklärung der tagungshotels.info UG
          (haftungsbeschränkt) beruht auf den Begrifflichkeiten, die durch den
        ...
        <p>tagungshotels.info UG (haftungsbeschränkt)</p>
        <p>In der Reith 12</p>
        <p>27386 Bothel</p>
        <p>Deutschland</p>
        <p>Tel.: +4942669999999</p>
        <p>E-Mail: info@tagungsghotels.info</p>
        <p>Website: https://tagungshotels.info</p>

        <h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
        <p>
          Die Internetseite der tagungshotels.info UG (haftungsbeschränkt)
        ...
        <p>
          ...
          tagungshotels.info UG (haftungsbeschränkt) keine Rückschlüsse auf
          ...
          Informationen werden durch die tagungshotels.info UG
          (haftungsbeschränkt) daher einerseits statistisch und ferner mit dem
        ...
        <ul style={{ listStyle: "none" }}>
          ...
          <li>
            ...
            <p>
              ...
              bei der tagungshotels.info UG (haftungsbeschränkt) gespeichert
              sind, veranlassen möchte, kann sie sich hierzu jederzeit an
              einen Mitarbeiter des für die Verarbeitung Verantwortlichen
              wenden. Der Mitarbeiter der tagungshotels.info UG
              (haftungsbeschränkt) wird veranlassen, dass dem Löschverlangen
              unverzüglich nachgekommen wird.
            </p>

            <p>
              Wurden die personenbezogenen Daten von der tagungshotels.info UG
              (haftungsbeschränkt) öffentlich gemacht und ist unser
              ...
              tagungshotels.info UG (haftungsbeschränkt) unter
              ...
              Der Mitarbeiter der tagungshotels.info UG (haftungsbeschränkt)
          ...
          <li>
            ...
            <p>
              ...
              Daten, die bei der tagungshotels.info UG (haftungsbeschränkt)
              gespeichert sind, verlangen möchte, kann sie sich hierzu
              jederzeit an einen Mitarbeiter des für die Verarbeitung
              Verantwortlichen wenden. Der Mitarbeiter der tagungshotels.info
              UG (haftungsbeschränkt) wird die Einschränkung der Verarbeitung
              veranlassen.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              tagungshotels.info UG (haftungsbeschränkt) wenden.
            </p>
          </li>
          <li>
            ...
            <p>
              Die tagungshotels.info UG (haftungsbeschränkt) verarbeitet die
            ...
            <p>
              Verarbeitet die tagungshotels.info UG (haftungsbeschränkt)
              personenbezogene Daten, um Direktwerbung zu betreiben, so hat
              die betroffene Person das Recht, jederzeit Widerspruch gegen die
              ...
              betroffene Person gegenüber der tagungshotels.info UG
              (haftungsbeschränkt) der Verarbeitung für Zwecke der
              Direktwerbung, so wird die tagungshotels.info UG
              (haftungsbeschränkt) die personenbezogenen Daten nicht mehr für
            ...
            <p>
              ...
              tagungshotels.info UG (haftungsbeschränkt) zu wissenschaftlichen
              oder historischen Forschungszwecken oder zu statistischen
            ...
            <p>
              ...
              Person direkt an jeden Mitarbeiter der tagungshotels.info UG
              (haftungsbeschränkt) oder einen anderen Mitarbeiter wenden. Der
          ...
          <li>
            ...
            <p>
              ...
              tagungshotels.info UG (haftungsbeschränkt) angemessene
